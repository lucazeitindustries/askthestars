    ...
    <div className="min-h-screen pt-28 pb-20 px-6">
      <div className="content-narrow">
        ...
        >
          ...
          <p className="text-tertiary text-sm">Weekly Horoscope</p>
        ...
        {loading ? (
          <div className="glass-card p-10 text-center">
            ...
            />
            <p className="text-sm text-tertiary mt-4">Consulting the stars...</p>
              ...
              <ScrollReveal>
                <div className="glass-card p-6 flex justify-around">
                  ...
                  {reading.challenge_day && (
                    <div className="text-center">
                      <p className="text-xs text-tertiary mb-1">Challenge Day</p>
            ...
            {reading.love_forecast && (
              <ScrollReveal delay={0.15}>
                <div className="glass-card p-8">
                  ...
                  <p className="text-secondary text-sm leading-relaxed font-light">{reading.love_forecast}</p>
                </div>
              </ScrollReveal>
            )}
            ...
            {reading.career_forecast && (
              <ScrollReveal delay={0.2}>
                <div className="glass-card p-8">
                  ...
                  <p className="text-secondary text-sm leading-relaxed font-light">{reading.career_forecast}</p>
                </div>
              </ScrollReveal>
            )}
            ...
            {reading.advice && (
              <ScrollReveal delay={0.25}>
                <div className="glass-card p-8 border border-gold/10">
                  ...
                  <p className="text-secondary text-sm leading-relaxed font-light italic">&ldquo;{reading.advice}&rdquo;</p>
                </div>
              </ScrollReveal>
            )}
          </motion.div>
        ...
        >
          <Link href={`/horoscope/${prev.slug}/weekly`} className="flex items-center gap-2 text-sm text-secondary hover:text-white transition-colors">
            <span>←</span><span>{prev.symbol} {prev.name}</span>
          </Link>
          <Link href={`/horoscope/${next.slug}/weekly`} className="flex items-center gap-2 text-sm text-secondary hover:text-white transition-colors">
